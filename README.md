...
**Bookstore** is a Single Page App (SPA) that displays a list of books with the authors. Along with adding, updating and removing books.
...
```sh
  cd my-folder
  git clone https://github.com/Bifabig/bookstore-react.git
```
